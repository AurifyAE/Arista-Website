            ...
            <div className="container mx-auto px-0">
                ...
                <div className="flex flex-col md:flex-row items-center gap-12">
                    <div className="w-full md:w-1/2">
                        ...
                        <p className="text-lg text-gray-700 leading-relaxed mb-6">
                            At Arista Gold, we believe in a future where tradition meets innovation, guided by the principles of sustainability, compliance, and value creation. Our operations are built on decades of experience, a robust understanding of the supply chain, and a commitment to leveraging these strengths for our clients' success.
                        </p>
                    </div>
