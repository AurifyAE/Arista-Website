...
const Products = () => {
    ...
    const products = [
        { image: productImage1, title: "Pamp Collection" },
        { image: productImage2, title: "Valcambi Suisse" },
        { image: productImage3, title: "SAM" },
        { image: productImage4, title: "Al Etihad" },
    ];
        ...
        <div className="w-full mt-16 flex flex-col items-center px-8 md:px-16 lg:px-36">
            ...
            <div className="w-full overflow-hidden">
                ...
                >
                    {products.map((product, index) => (
                        ...
                        >
                            <div
                                className="flex flex-col items-center transition-all duration-300 ease-in-out h-[250px] sm:h-[300px] md:h-[350px] lg:h-[382px] justify-center cursor-pointer products-hover bg-gray-50 rounded-lg hover:shadow-lg"
                            >
                                <img
                                    src={product.image}
                                    alt={`Product ${index + 1}`}
            ...
            <div className="flex space-x-4 justify-center md:justify-end max-sm:justify-end w-full mt-6 mb-8">
                ...
                <button
                    ...
                    className={`text-black px-3 py-2 sm:px-4 sm:py-2 rounded-full border-2 transition-opacity ${
                        currentIndexProducts === 0 ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100'
                    }`}
                ...
                <button
                    ...
                    className={`text-black px-3 py-2 sm:px-4 sm:py-2 rounded-full border-2 transition-opacity ${
                        currentIndexProducts >= products.length - maxVisibleSlides ? 'opacity-50 cursor-not-allowed' : 'hover:bg-gray-100'
                    }`}
