    ...
    const products = [
        {
            image: image1,
            altText: "Gold bars",
            title: "Unfixed Gold Purchase",
            description:
                "Precious metals are provided on consignment, and the price is fixed later based on mutual agreement.",
        },
        {
            image: image2,
            altText: "Gold and silver coins",
            title: "Custom Financing Options",
            description:
                "Designed to align with your operational needs and financial goals.",
        },
    ];
