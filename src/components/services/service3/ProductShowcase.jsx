    ...
    const products = [
        {
            ...
            title: "Hedging Tools",
            description:
                "Spot trading, futures, options, and margin trading to safeguard against price fluctuations.",
        },
        {
            image: coins,
            ...
            description:
                "Powered by internationally recognized liquidity providers, ensuring competitive spreads and high trust levels.",
        },
        {
            image: scrap,
            ...
            description:
                "AM/PM fixing based on LBMA rates, adjusted for regional premiums and discounts.",
        },
    ];
